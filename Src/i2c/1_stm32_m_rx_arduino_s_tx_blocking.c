...
int main(void)
{
    ...
    for(;;) {
        ...
        I2C_MasterSendData(&I2C_Handle, &read_len_command, 1, 0x68, I2C_ENABLE_SR);
        I2C_MasterReceiveData(&I2C_Handle, &len, 1, 0x68, I2C_ENABLE_SR);

        I2C_MasterSendData(&I2C_Handle, &read_data_command, 1, 0x68, I2C_ENABLE_SR);
        I2C_MasterReceiveData(&I2C_Handle, (uint8_t *) buffer, len, 0x68, I2C_DISABLE_SR);
    }
}
